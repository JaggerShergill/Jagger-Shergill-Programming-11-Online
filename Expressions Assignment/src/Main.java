public class Main {
    public static void main(String args[]){
        ...
        */
        ...
        System.out.println((10 * 0 + 2) - Math.pow(Math.sqrt(25), 3));
        System.out.println((0 + 2) - Math.pow(Math.sqrt(25), 3));
        System.out.println((2) - Math.pow(Math.sqrt(25), 3));
        System.out.println((2) - Math.pow(5, 3));
